...
const AskSPharmaWidget = memo(() => {
  ...
  <View style={askSPharmaStyles.container}>
    ...
    <TouchableOpacity style={askSPharmaStyles.chip} accessibilityRole="button" onPress={() => router.push('/doctors/specialty/cardiology')}>
...
const PhysioBanner = memo(() => {
  const router = useRouter();
  return (
  <TouchableOpacity style={physioStyles.container} accessibilityRole="button" accessibilityLabel="S-Pharma Physio at Home" onPress={() => router.push('/doctors/specialty/orthopaedics')}>
