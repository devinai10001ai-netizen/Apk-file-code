...
export const INSURANCE_DETAIL_PAGES = {
  ...
  insurance: {
    ...
    categories: [
      { id: 'health', name: 'Health', icon: 'heart', color: '#FF6B6B', gradient: ['#FF6B6B', '#EE5A24'], 
        ...
        insurers: ['Niva Bupa', 'Care Health', 'Star Health', 'S-Pharma Munich', 'ManipalCigna'],
      ...
      { id: 'senior-citizen', name: 'Senior Citizen', icon: 'accessibility', color: '#795548', gradient: ['#795548', '#5D4037'],
        ...
        insurers: ['Niva Bupa', 'Care Health', 'Star Health', 'S-Pharma Munich', 'Reliance General'],
  ...
  topup: {
    plans: [
      ...
      { id: 'S-pharma-pro', name: 'S-Pharma ProHealth Top-Up', insurer: 'S-Pharma Munich', coverage: '5L-50L', deductible: '3L-15L', premium: '₹3,200/yr',
  ...
  explore: {
    ...
    newLaunches: [
      { id: 'launch-1', name: 'S-Pharma ProHealth Plus', insurer: 'S-Pharma Munich', cover: '25L', premium: '₹899/mo', tag: 'Just Launched', color: '#9B59B6' },
